...
namespace StockTraderRI.Modules.Position.PositionSummary
{
    ...
    public class ObservablePosition : IObservablePosition
    {
        ...
        public ObservableCollection<Medicine> MedicineItems { get; private set; }
        ...
        public ObservablePosition(IAccountPositionService accountPositionService, IMarketFeedService marketFeedService, IEventAggregator eventAggregator)
        {
            ...
            this.MedicineItems = new ObservableCollection<Medicine>();
        ...
        private void PopulateItems()
        {
            ...
            this.accountPositionService.GetMedicines().ToList<Medicine>().ForEach(x => this.MedicineItems.Add(x));
        }
    }
}
